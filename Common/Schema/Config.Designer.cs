...
namespace UMSV.Schema
{
    ...
    public partial class Config : INotifyPropertyChanged
    {
        ...
        [XmlAttribute(AttributeName = "RecordPlayedTelephoneNumber")]
        public bool _RecordPlayedTelephoneNumber = false;

        public const string RecordPlayedTelephoneNumberProperty = "RecordPlayedTelephoneNumber";
        ...
        [XmlIgnore()]
        public bool RecordPlayedTelephoneNumber
        {
            get
            {
                return this._RecordPlayedTelephoneNumber;
            }
            set
            {
                if ((_RecordPlayedTelephoneNumber != value))
                {
                    this._RecordPlayedTelephoneNumber = value;
                    this.SendPropertyChanged("RecordPlayedTelephoneNumber");
                }
            }
        }
